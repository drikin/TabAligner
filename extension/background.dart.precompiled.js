...
function dart_precompiled($collectedClasses) {
  ...
  function alignTab_closure(currentTabId_0) {
    this.currentTabId_0 = currentTabId_0;
  }
  alignTab_closure.builtin$cls = "alignTab_closure";
  if (!"name" in alignTab_closure)
    alignTab_closure.name = "alignTab_closure";
  $desc = $collectedClasses.alignTab_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  alignTab_closure.prototype = $desc;
  function alignTab__closure(currentTabId_1, windowId_2, tabIndex_3, tabUri_4) {
    this.currentTabId_1 = currentTabId_1;
    this.windowId_2 = windowId_2;
    this.tabIndex_3 = tabIndex_3;
    this.tabUri_4 = tabUri_4;
  }
  alignTab__closure.builtin$cls = "alignTab__closure";
  if (!"name" in alignTab__closure)
    alignTab__closure.name = "alignTab__closure";
  $desc = $collectedClasses.alignTab__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  alignTab__closure.prototype = $desc;
  function alignTab___closure(currentTabId_5, tabUri_6) {
    this.currentTabId_5 = currentTabId_5;
    this.tabUri_6 = tabUri_6;
  }
  alignTab___closure.builtin$cls = "alignTab___closure";
  if (!"name" in alignTab___closure)
    alignTab___closure.name = "alignTab___closure";
  $desc = $collectedClasses.alignTab___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  alignTab___closure.prototype = $desc;
  function groupTabs_closure(allTabs_0) {
    this.allTabs_0 = allTabs_0;
  }
  groupTabs_closure.builtin$cls = "groupTabs_closure";
  if (!"name" in groupTabs_closure)
    groupTabs_closure.name = "groupTabs_closure";
  $desc = $collectedClasses.groupTabs_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs_closure.prototype = $desc;
  function groupTabs__closure(allTabs_1) {
    this.allTabs_1 = allTabs_1;
  }
  groupTabs__closure.builtin$cls = "groupTabs__closure";
  if (!"name" in groupTabs__closure)
    groupTabs__closure.name = "groupTabs__closure";
  $desc = $collectedClasses.groupTabs__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs__closure.prototype = $desc;
  function groupTabs__closure0(url_2) {
    this.url_2 = url_2;
  }
  groupTabs__closure0.builtin$cls = "groupTabs__closure0";
  if (!"name" in groupTabs__closure0)
    groupTabs__closure0.name = "groupTabs__closure0";
  $desc = $collectedClasses.groupTabs__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs__closure0.prototype = $desc;
  function groupTabs__closure1(allTabs_3) {
    this.allTabs_3 = allTabs_3;
  }
  groupTabs__closure1.builtin$cls = "groupTabs__closure1";
  if (!"name" in groupTabs__closure1)
    groupTabs__closure1.name = "groupTabs__closure1";
  $desc = $collectedClasses.groupTabs__closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs__closure1.prototype = $desc;
  function groupTabs__closure2() {
  }
  groupTabs__closure2.builtin$cls = "groupTabs__closure2";
  if (!"name" in groupTabs__closure2)
    groupTabs__closure2.name = "groupTabs__closure2";
  $desc = $collectedClasses.groupTabs__closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs__closure2.prototype = $desc;
  function groupTabs___closure(tabs_4) {
    this.tabs_4 = tabs_4;
  }
  groupTabs___closure.builtin$cls = "groupTabs___closure";
  if (!"name" in groupTabs___closure)
    groupTabs___closure.name = "groupTabs___closure";
  $desc = $collectedClasses.groupTabs___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs___closure.prototype = $desc;
  function groupTabs____closure() {
  }
  groupTabs____closure.builtin$cls = "groupTabs____closure";
  if (!"name" in groupTabs____closure)
    groupTabs____closure.name = "groupTabs____closure";
  $desc = $collectedClasses.groupTabs____closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs____closure.prototype = $desc;
  function groupTabs____closure0() {
  }
  groupTabs____closure0.builtin$cls = "groupTabs____closure0";
  if (!"name" in groupTabs____closure0)
    groupTabs____closure0.name = "groupTabs____closure0";
  $desc = $collectedClasses.groupTabs____closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  groupTabs____closure0.prototype = $desc;
  ...
  $desc = $collectedClasses.ChromeBrowserAction;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeBrowserAction.prototype = $desc;
  function ChromeBrowserAction$__closure(this_0) {
    this.this_0 = this_0;
  }
  ...
  $desc = $collectedClasses.ChromeBrowserAction$__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function TabsUpdateParams(jsProxy) {
    this.jsProxy = jsProxy;
  }
  TabsUpdateParams.builtin$cls = "TabsUpdateParams";
  if (!"name" in TabsUpdateParams)
    TabsUpdateParams.name = "TabsUpdateParams";
  $desc = $collectedClasses.TabsUpdateParams;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TabsUpdateParams.prototype = $desc;
  function TabsMoveParams(jsProxy) {
    this.jsProxy = jsProxy;
  }
  TabsMoveParams.builtin$cls = "TabsMoveParams";
  if (!"name" in TabsMoveParams)
    TabsMoveParams.name = "TabsMoveParams";
  $desc = $collectedClasses.TabsMoveParams;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TabsMoveParams.prototype = $desc;
  function TabsReloadParams(jsProxy) {
    this.jsProxy = jsProxy;
  }
  TabsReloadParams.builtin$cls = "TabsReloadParams";
  if (!"name" in TabsReloadParams)
    TabsReloadParams.name = "TabsReloadParams";
  $desc = $collectedClasses.TabsReloadParams;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TabsReloadParams.prototype = $desc;
  function ChromeWebNavigation(_onBeforeNavigate, _onCommitted, _onDOMContentLoaded, _onCompleted, _onErrorOccurred, _onCreatedNavigationTarget, _onReferenceFragmentUpdated, _onTabReplaced, _onHistoryStateUpdated) {
    this._onBeforeNavigate = _onBeforeNavigate;
    this._onCommitted = _onCommitted;
    this._onDOMContentLoaded = _onDOMContentLoaded;
    this._onCompleted = _onCompleted;
    this._onErrorOccurred = _onErrorOccurred;
    this._onCreatedNavigationTarget = _onCreatedNavigationTarget;
    this._onReferenceFragmentUpdated = _onReferenceFragmentUpdated;
    this._onTabReplaced = _onTabReplaced;
    this._onHistoryStateUpdated = _onHistoryStateUpdated;
  }
  ChromeWebNavigation.builtin$cls = "ChromeWebNavigation";
  if (!"name" in ChromeWebNavigation)
    ChromeWebNavigation.name = "ChromeWebNavigation";
  $desc = $collectedClasses.ChromeWebNavigation;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeWebNavigation.prototype = $desc;
  function ChromeWebNavigation$__closure(this_0) {
    this.this_0 = this_0;
  }
  ChromeWebNavigation$__closure.builtin$cls = "ChromeWebNavigation$__closure";
  if (!"name" in ChromeWebNavigation$__closure)
    ChromeWebNavigation$__closure.name = "ChromeWebNavigation$__closure";
  $desc = $collectedClasses.ChromeWebNavigation$__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeWebNavigation$__closure.prototype = $desc;
  function ChromeWindows(_windows0$_onCreated, _windows0$_onRemoved, _onFocusChanged) {
    this._windows0$_onCreated = _windows0$_onCreated;
    this._windows0$_onRemoved = _windows0$_onRemoved;
  ...
  function ChromeWindows$__closure(this_0) {
    this.this_0 = this_0;
  }
  ChromeWindows$__closure.builtin$cls = "ChromeWindows$__closure";
  if (!"name" in ChromeWindows$__closure)
    ChromeWindows$__closure.name = "ChromeWindows$__closure";
  $desc = $collectedClasses.ChromeWindows$__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeWindows$__closure.prototype = $desc;
  function ChromeWindows_getAll_closure() {
  }
  ChromeWindows_getAll_closure.builtin$cls = "ChromeWindows_getAll_closure";
  if (!"name" in ChromeWindows_getAll_closure)
    ChromeWindows_getAll_closure.name = "ChromeWindows_getAll_closure";
  $desc = $collectedClasses.ChromeWindows_getAll_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChromeWindows_getAll_closure.prototype = $desc;
  ...
  function WindowsGetAllParams(jsProxy) {
    this.jsProxy = jsProxy;
  }
  WindowsGetAllParams.builtin$cls = "WindowsGetAllParams";
  if (!"name" in WindowsGetAllParams)
    WindowsGetAllParams.name = "WindowsGetAllParams";
  $desc = $collectedClasses.WindowsGetAllParams;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WindowsGetAllParams.prototype = $desc;
